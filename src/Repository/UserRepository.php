...
class UserRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function vet_autocomplete_suggestions($q, array $userData) {
        ...
        if(isset($userData['branchId'])){
            $andWhere .= ' AND u.`branch_id` = :branchId';
        ...
        $sql = "
            ...
            AND u.`type` IN ('Med Tech','Vet Supervisor ','Procurement Assistant','Vet. Nurse', 'Veterinary Assistant','Lab Assistant', 'Veterinarian', 'Jr. Vet', 'Sr. Vet', 'Vet Tech', 'Medical Director','Practice Manager', 'Chief Operations Officer')
