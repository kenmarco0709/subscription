...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ExpenseTypeRepository")
 * @ORM\Table(name="expense_type")
 * @ORM\HasLifecycleCallbacks()
 */

class ExpenseTypeEntity extends BaseEntity
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="BranchEntity", inversedBy="ExpenseTypes")
